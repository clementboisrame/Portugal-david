...
const sendUserAccountCreation = (req, res) => {
  const { email } = req.body;

  const transporter = nodemailer.createTransport({
    host: "smtp.gmail.com",
    auth: {
      user: "immodavid4@gmail.com",
      pass: "44/immo*",
    },
  });
                                            ...
                                            <tr>
                                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                    <div
                                                        ...
                                                        <b>Sécurité:</b>
                                                        <p>
                                                            Si jamais vous n'êtes pas à l'origine de l'ouverture du compte,
...
const sendContactMessageMail = (req, res) => {
  const { email, message, ipLocal, request, date, name } = req.body;
...
const sendPasswordResetCompany = (req, res) => {
  const { email, ipLocal, date } = req.body;
...
module.exports = {
  ...
  sendCompanyAccountCreation,
  sendContactMessageMail,
  sendPasswordResetMail,
  sendPasswordResetCompany,
};
